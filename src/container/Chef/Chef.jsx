      ...
      <div className="app__chef-content">
        <div className="app__chef-content_quote">
          ...
          <p className="p__opensans">
            ...
            alias velit ratione rerum eveniet provident ad
          </p>
        </div>
        <p className="p__opensans">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea fuga
          quisquam ut soluta dicta porro distinctio eligendi sint magnam
          delectus tempore sequi amet cum non, temporibus molestiae{" "}
        </p>
      </div>
